...
export class GlobalSettings {
  ...
  kioskTheme: {
    ...
    layout?: {
      ...
      homeScreenBottomButtonsRightPadding?: number;
      homeScreenWelcomeTextLineSpacing?: number;
      homeScreenAddressTopSpacing?: number;
      ...
      homeScreenHeroTextPosition?: string;
      homeScreenCtaPosition?: string;
      homeScreenUtilityBarLayout?: string;
