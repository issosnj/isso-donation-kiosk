...
export default function ThemeTab() {
  ...
  const [formData, setFormData] = useState({
    ...
    layout: {
      ...
      detailsPageHorizontalSpacing: 20,
      detailsPageSidePadding: 40,
      detailsPageTopPadding: 60,
      detailsPageBottomPadding: 40,
      detailsCardMaxWidth: 350,
      donorFormMaxWidth: 350,
    ...
    if (temple?.kioskTheme) {
      setFormData({
        ...
        layout: {
          ...
          // Donation Details Page Layout
          detailsPageHorizontalSpacing: temple.kioskTheme.layout?.detailsPageHorizontalSpacing || 20,
          detailsPageSidePadding: temple.kioskTheme.layout?.detailsPageSidePadding || 40,
          detailsPageTopPadding: temple.kioskTheme.layout?.detailsPageTopPadding || 60,
          detailsPageBottomPadding: temple.kioskTheme.layout?.detailsPageBottomPadding || 40,
          detailsCardMaxWidth: temple.kioskTheme.layout?.detailsCardMaxWidth || 350,
          donorFormMaxWidth: temple.kioskTheme.layout?.donorFormMaxWidth || 350,
