...
import { OverviewIcon, TemplesIcon, DonationsIcon, UsersIcon, DevicesIcon, CategoriesIcon, StripeIcon, LogoutIcon, ReceiptIcon, ReligiousEventsIcon } from './Icons'
...
const iconMap: Record<string, () => JSX.Element> = {
  ...
  'donation-change-requests': DonationsIcon,
  users: UsersIcon,
  devices: DevicesIcon,
...
export default function Sidebar({ user, activeTab, setActiveTab, onLogout }: SidebarProps) {
  ...
  const masterTabs = [
    ...
    { id: 'donation-change-requests', label: 'Receipt changes' },
